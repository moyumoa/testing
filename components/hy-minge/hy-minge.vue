<template>
  <view class="container">
    <view class="tops">
      <view class="tops-l">
        <text class="tops-l-t">用户信息</text>
      </view>
      <view class="tops-r">
        <text class="tops-r-t">注册时间</text>
        <text class="tops-r-t">开通时间</text>
      </view>
    </view>
      ...
      <view class="panel">
        <view class="panel-l">
          ...
          <view class="panel-l-info">
            <text class="panel-l-info-title">张三</text>
            <text class="panel-l-info-t">当前身份: 拍客</text>
          </view>
        </view>
        <view class="panel-r">
          <text class="panel-r-t">02-21</text>
          <text class="panel-r-t">02-21</text>
        </view>
      </view>
    </view>
